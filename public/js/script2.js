...
function Carga(){
	...
	var route = "http://www.colsystem.net/cinema/public/genero";
...
function Eliminar(btn){
	var route = "http://www.colsystem.net/cinema/public/genero/"+btn.value+"";
	var token = $("#token").val();
...
function Mostrar(btn){
	var route = "http://www.colsystem.net/cinema/public/genero/"+btn.value+"/edit";
...
$("#actualizar").click(function(){
	var value = $("#id").val();
	var dato = $("#genre").val();
	var route = "http://www.colsystem.net/cinema/public/genero/"+value+"";
	var token = $("#token").val();
